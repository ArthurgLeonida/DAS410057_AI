...
def astar(initial_state, goal_deliveries, goal_cleans, heuristic, max_nodes=2000000):
    start = time.time()
    counter = 0
    ...
    while frontier and explored < max_nodes:
        ...
        for action in get_actions(state):
            ...
            if new_state not in visited or visited[new_state] > new_g:
                ...
                heapq.heappush(frontier, (new_g + h, counter, new_state, path + [(new_state, action, cost)], new_g))
